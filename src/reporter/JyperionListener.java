...
//		String file = System.getProperty("user.dir") + "\\Screenshots\\" + "screenshot" + (new Random().nextInt()) + ".jpeg";
//		try {
//			Screenshots.takeSnapShot(file);
//			//Driverclass.takeSnapShot(file);
//		} catch (Exception e) {
...
//		}
		...
		if (throwable != null) {
			...
			//Chunk imdb = new Chunk(" ", new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE, Font.UNDERLINE));
